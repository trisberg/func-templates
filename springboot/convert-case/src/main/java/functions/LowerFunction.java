...
@Component("lower")
public class LowerFunction implements Function<Message<String>, Message<String>> {
  private static final Logger LOGGER = Logger.getLogger(
    LowerFunction.class.getName());
  ...
  public Message<String> apply(Message<String> inputMessage) {
     ...
     */
     ...
     return CloudEventMessageBuilder.withData(input.toLowerCase())
